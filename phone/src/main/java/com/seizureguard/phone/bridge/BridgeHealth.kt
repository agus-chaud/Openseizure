...
enum class BridgeFault { NONE, NO_WATCH_DATA, OSD_UNREACHABLE, OSD_WRONG_DATASOURCE, OSD_REJECTS_DATA, OSD_DATA_STALE }
...
fun evaluate(
    ...
    // POSTs are accepted yet OSD's analysis timestamp is frozen (safety-review-pre-batch7 F1). Lowest precedence.
    osdDataStale -> BridgeFault.OSD_DATA_STALE
